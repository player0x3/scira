            ...
            messages: [
                {
                    ...
                    role: 'user',
                    parts: (messages[messages.length - 1].parts ?? null) as any,
                    attachments: (messages[messages.length - 1].experimental_attachments ?? []) as any,
                    createdAt: new Date(),
                },
            ],
        });
                                ...
                                messages: [
                                    {
                                        ...
                                        parts: (assistantMessage.parts ?? null) as any,
